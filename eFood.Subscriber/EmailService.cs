    ...
    public class EmailService
    {
        ...
        public void SendEmail(string message)
        {
            try
            {
                ...
                string fromMail = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "test12testovic@gmail.com";
                string password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "testovic12$TE";
